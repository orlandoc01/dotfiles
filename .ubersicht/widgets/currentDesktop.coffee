...
render: (output) ->
  """
    <div class="currentDesktop-container">
      <ul>
        <li id="desktop1"><img src="./assets/icons/system-file-manager-symbolic.svg" /></li>
        <li id="desktop2"><img src="./assets/icons/utilities-terminal-symbolic.svg" /></li>
        <li id="desktop3"><img src="./assets/icons/google-chrome-symbolic.svg" /></li>
        <li id="desktop4"><img src="./assets/icons/multimedia-audio-player-symbolic.svg" /></li>
      <ul>
    </div>
  """
