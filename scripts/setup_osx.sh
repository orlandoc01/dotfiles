...
curl https://raw.githubusercontent.com/orlandoc01/dotfiles/osx/Brewfile --output $HOME/.Brewfile
brew bundle

# setup dotfiles
alias dotfiles='/usr/bin/git --git-dir=$HOME/.dotfiles/ --work-tree=$HOME'
git clone -b osx --bare https://github.com/orlandoc01/dotfiles $HOME/.dotfiles
